...
public class FragmentoDia4 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragmento_dia4, container, false);
		desayuno = (TextView) rootView.findViewById(R.id.txt_desayuno_frag4);
		colacion1 = (TextView) rootView.findViewById(R.id.txt_colacion1_frag4);
		comida = (TextView) rootView.findViewById(R.id.txt_comida_frag4);
		colacion2 = (TextView) rootView.findViewById(R.id.txt_colacion2_frag4);
		cena = (TextView) rootView.findViewById(R.id.txt_cena_frag4);
