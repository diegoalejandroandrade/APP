...
public class FragmentoDia1 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragmento_dia1, container, false);
		desayuno = (TextView) rootView.findViewById(R.id.txt_desayuno_frag1);
		colacion1 = (TextView) rootView.findViewById(R.id.txt_colacion1_frag1);
		comida = (TextView) rootView.findViewById(R.id.txt_comida_frag1);
		colacion2 = (TextView) rootView.findViewById(R.id.txt_colacion2_frag1);
		cena = (TextView) rootView.findViewById(R.id.txt_cena_frag1);
