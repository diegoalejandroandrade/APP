...
public class FragmentoDia7 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragmento_dia7, container, false);
		desayuno = (TextView) rootView.findViewById(R.id.txt_desayuno_frag7);
		colacion1 = (TextView) rootView.findViewById(R.id.txt_colacion1_frag7);
		comida = (TextView) rootView.findViewById(R.id.txt_comida_frag7);
		colacion2 = (TextView) rootView.findViewById(R.id.txt_colacion2_frag7);
		cena = (TextView) rootView.findViewById(R.id.txt_cena_frag7);
