...
public class FragmentoDia5 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragmento_dia5, container, false);
		desayuno = (TextView) rootView.findViewById(R.id.txt_desayuno_frag5);
		colacion1 = (TextView) rootView.findViewById(R.id.txt_colacion1_frag5);
		comida = (TextView) rootView.findViewById(R.id.txt_comida_frag5);
		colacion2 = (TextView) rootView.findViewById(R.id.txt_colacion2_frag5);
		cena = (TextView) rootView.findViewById(R.id.txt_cena_frag5);
